!function () {
    ...
    class r extends React.Component {
        ...
        activatePad() {
            this.props.power ? "#08b498" === this.state.padStyle.backgroundColor ? this.setState({
                padStyle: s
            }) : this.setState({
                padStyle: a
    ...
    class o extends React.Component {
        ...
        render() {
            ...
            }, "AZY" + String.fromCharCode(160)), React.createElement("i", {
                className: "inner-logo fa fa-circle"
            })), React.createElement("div", {
