    ...
    class Calculator extends React.Component {
        ...
        handleEvaluate() {
            if (!this.state.currentVal.includes("Limit")) {
                ...
                for (; endsWithOperator.test(expression);) expression = expression.slice(0, -1);
        ...
        handleOperators(e) {
            if (!this.state.currentVal.includes("Limit")) {
                ...
                const { formula, prevVal } = this.state;
        ...
        handleDecimal() {
            if (this.state.evaluated) {
                ...
                if (!this.state.currentVal.includes(".") && !this.state.currentVal.includes("Limit")) {
                    ...
                    if (endsWithOperator.test(this.state.formula) || (this.state.currentVal === "0" && this.state.formula === "")) {
                        this.setState({
                            currentVal: "0.",
        ...
        render() {
            return (
                <div>
                    ...
                    <button id="divide" onClick={this.props.operators} style={operatorStyle} value="/">
                        /
                    </button>
                    <button id="multiply" onClick={this.props.operators} style={operatorStyle} value="x">
                        x
                    </button>
                    ...
                    <button id="subtract" onClick={this.props.operators} style={operatorStyle} value="-">
                        -
                    </button>
